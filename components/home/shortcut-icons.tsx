...
export function IconHomeS({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden>
      <path d="M16.8 7.1c-.7-1.4-2.2-2.2-4.3-2.2-3.3 0-5.3 1.8-5.3 4.2 0 2.2 1.5 3.4 4.4 4.1l1.5.4c1.6.4 2.2.9 2.2 1.8 0 1.1-1.1 1.9-2.8 1.9-1.7 0-3-.7-3.6-2.1l-2.3.8c.9 2.5 3.3 3.8 6 3.8 3.6 0 5.7-2 5.7-4.6 0-2.3-1.5-3.6-4.6-4.3l-1.5-.4c-1.5-.4-2.1-.9-2.1-1.7 0-1 .9-1.7 2.4-1.7 1.4 0 2.4.6 2.9 1.7l2.4-.7Z" />
    </svg>
  );
}
