  ...
  return (
    <div className="space-y-4 p-4">
      ...
      <article className="rounded-xl bg-white p-4 text-sm leading-relaxed text-[#374151]">
        <p>SportyBets is a demo sportsbook. Tap an odd to add it to the bet slip, enter a stake, then place the bet. Your wallet is debited only after the server accepts the ticket.</p>
